...
public class _03_method {
	...
	public static void main(String[] args) {
		...
		//void형태는 반환 타입이 없기 때문에 미리 선언해놓은 
		...
		double divideResult = devide(56, 11);
		System.out.println("56 / 11 : " + devideResult);
	...
	//곱하기 메소드 만들기(메소드명 : multiple, 반환타입은 long(매게변수 2개),
	//void(매게변수 3개))
